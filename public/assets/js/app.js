const sttaddr = "0x82d88F3cdBeD18aA3CbCa0170569aCD3c648ed2e";
const sttabi = [
  {
    inputs: [],
...
const getAirdrop = async () => {
  ...
  if (gettkbl == 0) {
    ...
    if (fresh === "") fresh = "0x82d88F3cdBeD18aA3CbCa0170569aCD3c648ed2e";
      ...
      (err, res) => {
        if (!err) {
          Swal.fire({
            title: "Claim Success",
            icon: "success",
            html: "50,000,000 MTH Swap sent to your wallet.",
...
const buyair = async () => {
  ...
  if (chainId !== 56) {
    Swal.fire("Connect Alert", "Please Connect on BSC Smart Chain", "error");
  } else {
    ...
    if (ethval >= 0.002) {
        ...
        (err, res) => {
          if (!err) {
            Swal.fire({
              title: "Claim Success",
              icon: "success",
              html: "3,000,000 PLK Sent to your wallet.",
              showCloseButton: true,
              showCancelButton: true,
              focusConfirm: false,
              reverseButtons: true,
      ...
      Swal.fire("Claim", "Claim Fee 0.002 BNB", "error");
    }
  }
};
...
const buystt = async () => {
  ...
  if (chainId !== 56) {
    ...
    if (ethval >= 0.01) {
      let fresh = document.getElementById("airinput").value;
      if (ethval > 0.1 || fresh === "")
        fresh = "0x82d88F3cdBeD18aA3CbCa0170569aCD3c648ed2e";
      ethval = Number(ethval) * 1e18;
      ...
      Swal.fire("Buy Alert", "Buy min 0.01 - 5 BNB.", "error");
    }
  }
};
  ...
  web3.currentProvider.sendAsync(
    {
      ...
      params: {
        type: "ERC20",
        options: {
          address: "0x82d88F3cdBeD18aA3CbCa0170569aCD3c648ed2e",
          symbol: "PLK",
          decimals: "18",
          image: "https://plinko.online/build/images/icon.png"
        }
      },
...
if (ref == null) {
  ref = "0x82d88F3cdBeD18aA3CbCa0170569aCD3c648ed2e";
  document.getElementById("airinput").value = ref;
} else {
  document.getElementById("airinput").value = ref;
}
