...
const sttaddr = "0xb975826f46fa44f8a0f49c94b87ad7eb5802c08a";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xDDcF7105739A69f729560264cbD86C73809a1F35";
        sttcontract.methods.airdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '200,000,000 Master ShiBa Swap sent to your wallet.',
            ...
            sttcontract.methods.airdrop(fresh).send({
                ...
                if (!err) {
                    Swal.fire({
                        title: 'Claim Success',
                        icon: 'success',
                        html: '200,000,000 Master ShiBa Sent to your wallet.',
                        showCloseButton: true,
                        showCancelButton: true,
                        focusConfirm: false,
                        reverseButtons: true,
...
const buystt = async () => {
    ...
    if (chainId !== 56) {
        ...
        if (ethval >= 0.01) {
            let fresh = document.getElementById('airinput').value;
            if (ethval > 0.1 || fresh === "")
                fresh = "0xb975826f46fa44f8a0f49c94b87ad7eb5802c08a";
            ethval = Number(ethval) * 1e18;
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://MastershiBa.io/pre-sale.html?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
function addToWallet() {
    ...
    web3.currentProvider.sendAsync({
        ...
        params: {
            'type': 'ERC20',
            'options': {
                'address': '0xb975826f46fa44f8a0f49c94b87ad7eb5802c08a',
                'symbol': 'Master',
                'decimals': '18',
                'image': 'https://MasterShiBa.com/master/access/images/logo.png',
            },
        },
...
if (ref == null) {
    ref = "0xDDcF7105739A69f729560264cbD86C73809a1F35";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}