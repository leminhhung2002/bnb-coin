                    ...
                    >
                      ...
                      <li className="menu-item">
                        <a
                          ...
                          href="https://docs.bnbkingdom.io/team-development"
                        >
                          Team
                        </a>
                      </li>
                      ...
                      <li className="menu-item">
                        <a
                          className="menu-link nav-link"
                          href="https://docs.bnbkingdom.io/partners"
                        >
                          Partner
                        </a>
                      </li>
                            ...
                            <ul className="icon-list">
                              <li>
                                ...
                                <div className="circle">
                                  <a href="#">
                                    <em className="new-social-icon fab fa-facebook" />
                                  </a>
                                </div>
                              </li>
                              <li>
        ...
        <div className="container">
          <div className="section-head section-head-s9 wide-md">
            ...
            <div className="wide-sm">
              ...
              <a
                href="https://www.pinksale.finance/#/pinklock/record/31582?chain=BSC"
                className="btn btn-md btn-grad btn-grad-alt no-change"
              >
                  ...
                  <div className="col-sm-3">
                    ...
                    >
                      ...
                      <div className="token-stage-info">
                        ...
                        <div>
                          <span className="toke-stage-cap">1 BNB – 10 BNB</span>
                        </div>
                      </div>
                    </div>
                  </div>
